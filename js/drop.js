document.addEventListener('DOMContentLoaded', () => {
    ...
    function showCart() {
        ...
        document.getElementById('cart-container').innerHTML = cartItemCount > 0 ?
            `<a href="shopping-cart.html">${cartItemCount}<img src="image/Cart.png" class="icons_img_w_h"></a>` : '';
    }

    // Show cart image when page starts
    showCart();
});
